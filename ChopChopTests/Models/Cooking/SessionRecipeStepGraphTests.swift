...
class SessionRecipeStepGraphTests: XCTestCase {
    func testConstruct() throws {
        ...
        guard let graph = try? SessionRecipeStepGraph(graph: recipeStepGraph) else {
