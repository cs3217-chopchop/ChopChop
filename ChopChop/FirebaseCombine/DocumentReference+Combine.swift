...
//                subscriber: subscriber, documentReference: documentReference, includeMetadataChanges: includeMetadataChanges)
...
//    }
//
//    public func publisher<D: Decodable>(includeMetadataChanges: Bool = true,
//        as type: D.Type,
//        documentSnapshotMapper: @escaping (DocumentSnapshot) throws -> D? = DocumentSnapshot.defaultMapper()) -> AnyPublisher<D?, Error> {
...
//    }
//
//    public func getDocument<D: Decodable>(source: FirestoreSource = .default,
//        as type: D.Type,
//        documentSnapshotMapper: @escaping (DocumentSnapshot) throws -> D? = DocumentSnapshot.defaultMapper()) -> AnyPublisher<D?, Error> {
...
//    }
//
//    public func cacheFirstGetDocument<D: Decodable>(as type: D.Type,
//        documentSnapshotMapper: @escaping (DocumentSnapshot) throws -> D? = DocumentSnapshot.defaultMapper()) -> AnyPublisher<D?, Error> {
