...
struct CountdownTimer2View: View {
    @ObservedObject var viewModel: CountdownTimer2ViewModel
...
struct CountdownTimer2View_Previews: PreviewProvider {
    static var previews: some View {
        CountdownTimer2View(viewModel: CountdownTimer2ViewModel(timer: CountdownTimer2(duration: 10)))
    }
}
